...
module.exports = function(element) {
  ...
  switch (element[0].name) {
    ...
    case this.components.wrap:
      ...
      return format('<div %s class="%s"><!--[if (gte mso 9)|(IE)]><table width="600" align="center"><tr><td><![endif]--><table class="outer" cellpadding="0" align="center">%s</table><!--[if (gte mso 9)|(IE)]></td></tr></table><![endif]--></div>', attrs, classes.join(' '), inner);
    // custom row - rower
    case this.components.rower:
      ...
      switch (cols) {
        case '1': 
          return format('<tr %s class="%s"><td class="one-column"><div class="column"><table width="100%"><tr><td>%s</td></tr></table></div></td></tr>', attrs, classes.join(' '), inner);
        case '2': 
          return format('<tr %s class="%s"><td class="two-columns"><!--[if (gte mso 9)|(IE)]><table width="100%"><tr><td width="50%" valign="top"><![endif]-->%s<!--[if (gte mso 9)|(IE)]></td></tr></table><![endif]--></td></tr>', attrs, classes.join(' '), inner);
        case '3': 
          return format('<tr %s class="%s"><td class="three-columns"><!--[if (gte mso 9)|(IE)]><table width="100%"><tr><td width="33%" valign="top"><![endif]-->%s<!--[if (gte mso 9)|(IE)]></td></tr></table><![endif]--></td></tr>', attrs, classes.join(' '), inner);
        default:
          return format('<tr %s class="%s"><td class="one-column"><div class="column"><table width="100%"><tr><td>%s</td></tr></table></div></td></tr>', attrs, classes.join(' '), inner);
      }
